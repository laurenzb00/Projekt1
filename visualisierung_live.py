...
class LivePlotApp:
    def __init__(self, root, fullscreen=True):
        ...
        self.system_status_label = ttk.Label(
            self.root, textvariable=self.system_status_var,
            style="Dark.TLabel", anchor="e"
        )
    ...
    # --------------------------------------------------------
    # Systemstatus prüfen (CSV-Aktualität)
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    # Haupt-Update-Funktion für alle Plots
    # --------------------------------------------------------
    def update_plots(self):
        ...
        try:
            ...
            for icon, x, y, value, label in icon_positions:
                ...
                self.summary_ax.text(x + 0.11, y, label, fontsize=17, color="white",
                                     va="center", ha="left", weight="bold", zorder=3)
                self.summary_ax.text(x + 0.65, y, value, fontsize=19, color="white",
                                     va="center", ha="left", weight="bold", zorder=3)
        ...
        # --- Timestamps für Status-Monitor updaten ---
        try:
